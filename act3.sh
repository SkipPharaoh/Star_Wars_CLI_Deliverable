...
mv chewbacca.txt princess_leia.txt han_solo.txt luke_skywalker.txt obi_wan.txt ~/sei1213/unit1/homework/Star_Wars_CLI_Deliverable/star_wars/empire/death_star 
...
mv chewbacca.txt princess_leia.txt han_solo.txt luke_skywalker.txt ~/sei1213/unit1/homework/Star_Wars_CLI_Deliverable/star_wars/empire/death_star/millenium_falcon 
# 4. Move the millenium_falcon back into the rebellion directory.
mv millenium_falcon ~/sei1213/unit1/homework/Star_Wars_CLI_Deliverable/star_wars/rebellion
# 5. darth_vader leaves the death_star to pursue luke_skywalker! Move him from the death_star into the empire directory!
mv darth_vader.txt ~/sei1213/unit1/homework/Star_Wars_CLI_Deliverable/star_wars/empire 
